...
public class ConversationViewController implements View.OnClickListener, LayerChangeEventListener.MainThread, TextWatcher, LayerTypingIndicatorListener {
    ...
    public ConversationViewController(MainChatActivity ma, LayerClient client) {
        ...
        //Change the layout
        ma.setContentView(R.layout.chat_main);
    ...
    private void sendButtonClicked(){
        ...
        if(activeConversation == null){
            ...
            if(activeConversation == null){
                activeConversation = layerClient.newConversation(MainChatActivity.getAllParticipants());
            }
        }
    ...
    private void sendMessage(String text) {
        ...
        metadata.put("layer-push-message", MainChatActivity.getUserID() + ": " + text);
    ...
    public static String getInitialMessage(){
        return "Hi there my name is , " + MainChatActivity.getUserID();
    }
